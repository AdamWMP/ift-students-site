  ...
  return (
    <>
      ...
      <section className="py-16 sm:py-24 bg-charcoal-950 relative overflow-hidden">
        <div className="absolute inset-0 pointer-events-none">
          <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[800px] h-[400px] bg-gold/5 rounded-full blur-[160px]" />
        </div>
        <div className="max-w-[1100px] mx-auto px-4 sm:px-6 relative z-10">
          ...
          >
            <p className="text-sm tracking-[0.25em] text-gold uppercase mb-3 font-semibold">The Full Picture</p>
            <h2 className="font-serif text-3xl sm:text-4xl text-white mb-4">
              This is what your journey <span className="text-gold italic">looks like.</span>
            </h2>
            <p className="text-white/50 max-w-xl mx-auto">
              From day one in the classroom to your first clients, your brand, your business — this is the Image journey from start to finish.
            </p>
          </motion.div>
