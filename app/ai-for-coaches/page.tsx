    ...
    <form onSubmit={submit} className="space-y-4">
      ...
      {error && (
        <div className="bg-red-500/8 border border-red-500/20 rounded-xl p-4 space-y-3">
          ...
          <div className="flex flex-col items-center gap-1.5 pt-1 border-t border-red-500/20">
            <p className="text-red-300/70 text-xs pt-2">Don&apos;t worry — our accounts team can sort it in minutes.</p>
            <a
